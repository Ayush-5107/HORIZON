  ...
  return (
    <div className={cn("group relative overflow-hidden brutal-border bg-card brutal-shadow transition-all duration-300", className)}>
      ...
      <img
        ...
        className={cn(
          "h-full w-full pixel-dither transition-transform duration-500 group-hover:scale-110",
        ...
        <>
          ...
          {user && (
            <button
              ...
              aria-label={isWatched ? `Remove ${movie.title} from watchlist` : `Add ${movie.title} to watchlist`}
